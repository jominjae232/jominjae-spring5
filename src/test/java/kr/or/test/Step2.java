...
class MemberVO {
	...
	// String을 반환(return)=출력하는 겟 메서드입니다(아래)
	public String getPhoneNum() {
		return phoneNum;
	}
	// void한(반환값이 없이) 입력하는 셋 메서드입니다.(아래)
	public void setPhoneNum(String phoneNum) {
		this.phoneNum = phoneNum;//프라이빗 변수를 직접 접근을 못하니까 퍼블릿 메서드로 입력하게 만들어 놓은 구조입니다.
	}
...
class MemberService {
	...
	public void printMember(MemberVO[] members) {
		// 멤버 서비스 클래스에서 퍼블릿 접근 제어로 회원 정보를 출력하는 메서드 생성
		// 향상된 for문을 사용합니다.
