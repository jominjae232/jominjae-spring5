    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="col-12 text-right">
          <a href="/admin/member/member_insert_from?page=${pageVO.page}&search_keyword=${pageVO.search_keyword}$search_type=${pageVO.search_type}" class="btn btn-primary mb-3">회원등록</a>
