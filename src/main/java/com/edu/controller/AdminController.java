...
public class AdminController {
	...
	@RequestMapping(value="/admin/member/member_update_from", method=RequestMethod.POST)
	...
	public String deleteMember(MemberVO memberVO) throws Exception{
		...
		//위 방식대로 하면, 새로고침하면, /admin/member/member_delete 계속 실행됩니다.
		//게시판 테러 상황을 방지하기 위해서, 쿼리를 작업 후 이동할떄는 redirect(다시 접속)라는 명령을 사용합니다.
